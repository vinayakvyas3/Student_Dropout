...
function Bygender() {
  ...
  for (let i = 0; i < StudentDetail.length; i++) {
    if (StudentDetail[i].studentGender == "Male" && StudentDetail[i].studentDropoutYear=="2023") Male23++;
    if (StudentDetail[i].studentGender == "Male" && StudentDetail[i].studentDropoutYear=="2022") Male22++;
    if (StudentDetail[i].studentGender == "female" && StudentDetail[i].studentDropoutYear=="2023") Female23++;
    if (StudentDetail[i].studentGender == "female" && StudentDetail[i].studentDropoutYear=="2022") Female22++;
  }
